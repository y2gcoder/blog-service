package com.y2gcoder.blog.aop;

import com.y2gcoder.blog.config.security.guard.AuthHelper;
...
public class AssignMemberIdAspect {
	...
	@Before("@annotation(com.y2gcoder.blog.annotation.AssignMemberId)")
	public void assignMemberId(JoinPoint joinPoint) {
		Arrays.stream(joinPoint.getArgs())
				.forEach(arg ->
						getMethod(arg.getClass(), "setMemberId")
								.ifPresent(setMemberId -> invokeMethod(arg, setMemberId, AuthHelper.extractUserId())));
	}
